...
export async function queryUser (params) {
  return QL.find_many('user', deleteEmptyProperty(params), [  'userData_id',  'id',  'createdAt',  'username',  'telephone',  'password',  'updatedAt',  'email',  ]);
}
export async function queryOneUser (params) {
  return QL.find_one('user', params, [  'userData_id',  'id',  'createdAt',  'username',  'telephone',  'password',  'updatedAt',  'email']);
}
